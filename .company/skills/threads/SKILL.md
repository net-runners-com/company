...
| 種別 | パス |
|------|------|
| 投稿スクリプト | `.company/sns/threads/post_to_threads.py` |
| スタイル定義 | `.company/sns/threads/references/styles/` |
| 投稿テキスト保存先 | `.company/sns/threads/output/{style}/` |
| 投稿ログ | `.company/sns/threads/logs/posts.log` |
| 競合分析 | `.company/sns/threads/research/` |
