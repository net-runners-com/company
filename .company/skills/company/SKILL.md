...
| 部署テンプレート | `.company/skills/company/references/departments.md` |
| CLAUDE.md生成テンプレート | `.company/skills/company/references/claude-md-template.md` |
...
- 部署別テンプレート: `.company/skills/company/references/departments.md`
- CLAUDE.md 生成テンプレート: `.company/skills/company/references/claude-md-template.md`
