...
const navLabels: Record<string, Record<string, string>> = {
  ja: {
    ...
    sales: "営業", finance: "財務", integrations: "SNS連携", automation: "自動化", schedule: "カレンダー", activity: "アクティビティ", settings: "設定",
  },
  en: {
    dashboard: "Home", secretary: "Secretary", directive: "Directive", employees: "Employees",
    sales: "Sales", finance: "Finance", integrations: "Integrations", automation: "Automation", schedule: "Calendar", activity: "Activity", settings: "Settings",
  },
};
