                ...
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                    active
                      ...
                      : "text-[var(--color-subtext)] hover:bg-[var(--color-border-light)] hover:text-[var(--color-text)]"
                  }`}
                >
                  {item.icon}
                  {t.nav[item.key]}
        ...
        <div className="px-4 py-4 border-t border-[var(--color-border)]">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-[var(--color-text)] truncate">Hiroto</p>
              <p className="text-xs text-[var(--color-subtext)]">Free Plan</p>
            </div>
          </div>
          {/* Locale Switcher */}
