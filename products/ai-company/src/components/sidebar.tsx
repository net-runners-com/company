...
const navItems: NavItem[] = [
  ...
  {
    href: "/secretary", key: "secretary", dept: "general-affairs",
  ...
  {
    href: "/sales", key: "sales", dept: "sales",
...
const navLabels: Record<string, Record<string, string>> = {
  ja: {
    ...
    sales: "営業", finance: "財務", integrations: "SNS連携", automation: "自動化", schedules: "定期実行", schedule: "カレンダー", activity: "アクティビティ", settings: "設定",
  },
  en: {
    dashboard: "Home", secretary: "Secretary", directive: "Directive", employees: "Employees",
    sales: "Sales", finance: "Finance", integrations: "Integrations", automation: "Automation", schedules: "Schedules", schedule: "Calendar", activity: "Activity", settings: "Settings",
  },
};
