...
| 種別 | パス |
|------|------|
| 組織ルール | `company/CLAUDE.md` |
| 部署テンプレート | `.claude/skills/company/references/departments.md` |
| CLAUDE.md生成テンプレート | `.claude/skills/company/references/claude-md-template.md` |
| 秘書室 | `company/back-office/general-affairs/` |
...
3. `back-office/general-affairs/` とサブフォルダ（`inbox/`, `todos/`, `notes/`）を作成
4. `references/departments.md` の「general-affairs/CLAUDE.md」テンプレートから `back-office/general-affairs/CLAUDE.md` を生成
5. 今日の日付で `back-office/general-affairs/todos/YYYY-MM-DD.md` を作成（departments.md のTODOテンプレートを使用）
...
| パターン                 | 対応                                                   |
| ------------------------ | ------------------------------------------------------ |
| TODO・タスク関連         | `back-office/general-affairs/todos/` の今日のファイルに追記・表示        |
| 壁打ち・相談・ブレスト   | 対話で深掘りし、まとまったら `back-office/general-affairs/notes/` に保存 |
| メモ・クイックキャプチャ | `back-office/general-affairs/inbox/` にタイムスタンプ付きで記録          |
...
2. **該当部署が存在しない場合** → `back-office/general-affairs/notes/` に結果を保存
...
2. `company/[department-path]/` フォルダとサブフォルダを作成
3. 部署の `CLAUDE.md` を配置
...
- 部署別テンプレート: `.claude/skills/company/references/departments.md`
- CLAUDE.md 生成テンプレート: `.claude/skills/company/references/claude-md-template.md`
